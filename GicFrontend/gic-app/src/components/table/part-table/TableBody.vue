    ...
    <tbody>
        ...
        <tr v-for="(row,indexRow) in dataTable">
            ...
            <td>
                ...
                <button type="button" class="btn btn-success" @click="updateShowModal('ubah', row.id)">
                    Ubah
                </button>
            </td>
            <td>
                <!-- menghapus row table -->
                <button type="button" class="btn btn-danger" @click="hapusRow(row.id)">
                    Hapus
                </button>
            </td>
        </tr>        
...
export default {
    ...
    setup(){
        ...
        return{
            updateShowModal, dataTable, showData
        }
    },
    methods: {
