...
const sequelize = new Sequelize(dbConfig.mysql.DB, any, dbConfig.mysql.USER, any, dbConfig.mysql.PASSWORD, any, {
    host: dbConfig.mysql.HOST, any,
    dialect: dbConfig.mysql.dialect, any,
